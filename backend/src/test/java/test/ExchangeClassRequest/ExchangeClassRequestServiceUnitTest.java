...
public class ExchangeClassRequestServiceUnitTest {
...
//    }
    ...
    public void testFindByClassCode() {
        ...
        for (int i = 0; i < testCases.size(); i++) {
            ...
            when(repository.findByCurrentClassCode(expected.getCurrentClassCode(),page))
            ...
            verify(repository, times(1)).findByCurrentClassCode(expected.getCurrentClassCode(), page);
        }
